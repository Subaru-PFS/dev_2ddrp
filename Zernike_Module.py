...
class ZernikeFitter_PFS(object):
    ...
    def __init__(self, image=None,image_var=None,pixelScale=None,wavelength=None,
                 ...
                 wf_full_Image=None,radiometricEffectArray_Image=None,ilum_Image=None,dithering=None,**kwargs):
        """
    ...
    def initParams(self, zmax=11, z4Init=None, dxInit=None,dyInit=None,hscFracInit=None,strutFracInit=None,
        ...
        @param scattering_radiusInit     minimal radius to which extended the scattering (in microns)
    ...
    def constructModelImage_PFS_naturalResolution(self,params=None,shape=None,pixelScale=None,jacobian=None):
        ...
        fiber = astropy.convolution.Tophat2DKernel(round(oversampling*1*1.80*self.dithering),mode='center').array
...
class LN_PFS_single(object):
    ...
    def __init__(self,sci_image,var_image,dithering=None):    
        """
        @param image        image to analyze
        @param image_var    variance image
        """          
        ...
        single_image_analysis=ZernikeFitter_PFS(sci_image,var_image,npix=npix_value,dithering=dithering)
    ...
    def lnlike_Neven(self,allparameters):
        ...
        # flux
        if globalparameters[17]<0.8:
            return -np.inf
        if globalparameters[17]>1.2:
            return -np.inf      
...
def create_parInit(allparameters_proposal=None):
    ...
    try:
        ...
        # flux
        globalparameters_flat_17=np.random.normal(globalparameters_flatten[17],0.025,nwalkers*20)
        globalparameters_flat_17=np.concatenate(([globalparameters_flatten[17]],
                                                 globalparameters_flat_17[np.all((globalparameters_flat_17>0.8,globalparameters_flat_17<1.2),axis=0)][0:nwalkers-1]))
        ...
        globalparameters_flat=np.column_stack((globalparameters_flat_0,globalparameters_flat_1,globalparameters_flat_2,globalparameters_flat_3
                                              ...
                                              globalparameters_flat_8,globalparameters_flat_9,globalparameters_flat_10,
                                               ...
                                               globalparameters_flat_14,globalparameters_flat_15,globalparameters_flat_16,globalparameters_flat_17))
    except NameError:
        print("NameError")
