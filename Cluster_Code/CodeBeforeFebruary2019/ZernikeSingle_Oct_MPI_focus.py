...
NAME_OF_CHAIN='chainOct10_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_LIKELIHOOD_CHAIN='likechainOct10_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_PUPIL_RES='pupilOct10_Single_P_'+str(obs)
...
with open(DATA_FOLDER + 'results_of_fit_many_interpolation.pkl', 'rb') as f:
