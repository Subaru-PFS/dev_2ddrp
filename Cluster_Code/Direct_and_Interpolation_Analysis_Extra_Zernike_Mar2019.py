...
v01 - investgation on a single object, from z11 to z22
v02 - using for the test on single object, arc=HgAr, singlespot=102

# run by e.g., python /home/ncaplar/Code/Direct_and_Interpolation_Analysis_Extra_Zernike_Mar2019.py 11796 102 6 5 HgAr
# run by e.g., python /home/ncaplar/Code/Direct_and_Interpolation_Analysis_Extra_Zernike_Mar2019.py 11790 102 6 5 HgAr
# run by e.g., python /home/ncaplar/Code/Direct_and_Interpolation_Analysis_Extra_Zernike_Mar2019.py 11784 102 6 5 HgAr
# run by e.g., python /home/ncaplar/Code/Direct_and_Interpolation_Analysis_Extra_Zernike_Mar2019.py 11730 102 6 5 HgAr
# run by e.g., python /home/ncaplar/Code/Direct_and_Interpolation_Analysis_Extra_Zernike_Mar2019.py 11736 102 6 5 HgAr
"""
...
if labelInput=='m4':    
    full_proposal=np.array([   28.88447634,     0.1367843 ,    -0.96521754,     0.37185392,
          -0.00454034,     0.07365062,    -0.28927672,    -0.29734563,
...
if labelInput=='m35':    
    full_proposal=np.array([   25.16942849,     0.09401025,    -0.89707616,     0.36235132,
          -0.00496471,     0.06477662,    -0.28618952,    -0.31467234,
           0.68081149,     0.07713529,     0.00830818,     0.01148621,
           0.06101173,     0.00871411,     0.00000017,     0.00000016,
           0.97281742,     0.94833808,    -0.0080463 ,    -0.06511615,
           0.82896283,     0.10363419,     0.87279571,     1.02065793,
          -0.04021679, 82615.33725161,     2.41431673,     0.00197545,
           0.35022209,     1.83833508,     0.99851325])
if labelInput=='m3':    
    full_proposal=np.array([   21.45438063,     0.0512362 ,    -0.82893477,     0.35284872,
          -0.00538908,     0.05590261,    -0.28310232,    -0.33199905,
           0.68081149,     0.07713529,     0.00830818,     0.01148621,
           0.06101173,     0.00871411,     0.00000017,     0.00000016,
           0.97281742,     0.94833808,    -0.0080463 ,    -0.06511615,
           0.82896283,     0.10363419,     0.87279571,     1.02065793,
          -0.04021679, 82615.33725161,     2.41431673,     0.00197545,
           0.35022209,     1.83833508,     0.99851325])
if labelInput=='p35':    
    full_proposal=np.array([  -26.84124146,    -0.50482645,     0.05690327,     0.22931491,
          -0.01090588,    -0.05945948,    -0.24296869,    -0.5572463 ,
           0.68081149,     0.07713529,     0.00830818,     0.01148621,
           0.06101173,     0.00871411,     0.00000017,     0.00000016,
           0.97281742,     0.94833808,    -0.0080463 ,    -0.06511615,
           0.82896283,     0.10363419,     0.87279571,     1.02065793,
          -0.04021679, 82615.33725161,     2.41431673,     0.00197545,
           0.35022209,     1.83833508,     0.99851325])
if labelInput=='p4':    
    full_proposal=np.array([  -30.55628931,    -0.54760049,     0.12504466,     0.21981231,
          -0.01133025,    -0.06833349,    -0.23988148,    -0.57457301,
           0.68081149,     0.07713529,     0.00830818,     0.01148621,
           0.06101173,     0.00871411,     0.00000017,     0.00000016,
           0.97281742,     0.94833808,    -0.0080463 ,    -0.06511615,
           0.82896283,     0.10363419,     0.87279571,     1.02065793,
...
zmax_input_results_of_fit_many=11
