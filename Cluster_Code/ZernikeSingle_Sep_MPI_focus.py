...
NAME_OF_CHAIN='chainSep28_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_LIKELIHOOD_CHAIN='likechainSep28_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_PUPIL_RES='pupilSep28_Single_P_'+str(obs)
...
with open(DATA_FOLDER + 'results_of_fit_many_interpolationSep27.pkl', 'rb') as f:
...
while len(parInit1)<options[0]:
    parInit1_2=create_parInit(allparameters_proposal,None,None,None,None,1)
...
parInit1=create_parInit(minchain,None,pupil_parameters,minchain_err,None,1)
...
##################################################################################################################### 
# Second swarm  
parInit1=create_parInit(minchain,None,pupil_parameters,minchain_err,stronger=10,use_optPSF=1)
while len(parInit1)<options[0]:
    parInit1_2=create_parInit(minchain,None,pupil_parameters,minchain_err,stronger=10,use_optPSF=1)
    parInit1=np.vstack((parInit1,parInit1_2))
...
parInit1=create_parInit(minchain,None,pupil_parameters,None,stronger=10,use_optPSF=1)
