...
NAME_OF_CHAIN='chainSep19_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_LIKELIHOOD_CHAIN='likechainSep19_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_PUPIL_RES='pupilSep19_Single_P_'+str(obs)
