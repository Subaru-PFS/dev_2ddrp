...
NAME_OF_CHAIN='chainSep27_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_LIKELIHOOD_CHAIN='likechainSep27_Single_P_'+str(obs)+str(xycoordinates)+str(eps)
NAME_OF_PUPIL_RES='pupilSep27_Single_P_'+str(obs)
